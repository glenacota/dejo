...
const TAB_BUTTON_CLASS = {
    active: {
        ...
        verbs: 'flex-1 px-5 py-3 rounded-lg text-base font-semibold transition-all flex items-center justify-center space-x-2 bg-purple-600 text-white shadow-md',
    },
    inactive: 'flex-1 px-5 py-3 rounded-lg text-base font-semibold transition-all flex items-center justify-center space-x-2 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200',
};
